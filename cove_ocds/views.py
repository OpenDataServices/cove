        ...
        with open(file_name, encoding='utf-8') as fp:
            try:
                ...
                raise CoveInputDataError(context={
                    ...
                    'msg': _(format_html("The file that you uploaded doesn't appear to be well formed JSON. OCDS JSON follows the I-JSON format, which requires UTF-8 encoding. Ensure that your file uses UTF-8 encoding, then try uploading again."
