...
@pytest.mark.parametrize(('link_text', 'url'), [
    ...
    ('convert to xml', '?source_url=https://raw.githubusercontent.com/OpenDataServices/iati-sample-data/master/IATI-CoVE-sample-activity-standard.xml?raw=true'),
    ('xml', 'https://github.com/OpenDataServices/iati-sample-data/blob/master/IATI-CoVE-sample-activity-standard.xml'),
    ('convert to spreadsheet', '?source_url=https://docs.google.com/spreadsheets/d/1WkCin68arZkAIhjxmKkml0MAskLcw9mkHctNmB_gH2I/export?format=xlsx'),
...
@pytest.mark.parametrize(('link_text', 'url'), [
    ...
    ('convert to xml', '?source_url=https://raw.githubusercontent.com/OpenDataServices/iati-sample-data/master/IATI-CoVE-sample-organisation-standard.xml?raw=true'),
    ('xml', 'https://github.com/OpenDataServices/iati-sample-data/blob/master/IATI-CoVE-sample-organisation-standard.xml'),
    ('convert to spreadsheet', '?source_url=https://docs.google.com/spreadsheets/d/1MXjepDgfzKw0ULUWzKmXVS0Al6rMhMHlgN-ZF6hLc70/export?format=xlsx'),
...
def check_url_input_result_page(server_url, browser, httpserver, source_filename, expected_text, conversion_successful):
    ...
    if source_filename == 'namespace_good.xlsx':
        ...
        assert requests.get(converted_file).text == '''<iati-activities>
