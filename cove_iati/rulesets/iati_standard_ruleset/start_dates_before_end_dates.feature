Feature: Start dates chronologically before end dates
  ...
  Scenario Outline: result:indicator:period-start @iso-date must be before period-end @iso-date
  ...
  Scenario Outline: recipient-organisation-budget:period-start @iso-date must be before period-end/@iso-date
  ...
  Scenario Outline: recipient-region-budget:period-start @iso-date must be before period-end @iso-date
  ...
  Scenario Outline: planned-disbursement:period-start @iso-date must be before period-end @iso-date
  ...
  Scenario Outline: recipient-country-budget:period-start @iso-date must be before period-end @iso-date
  ...
  Scenario Outline: total-expenditure:period-start @iso-date must be before period-end @iso-date
  ...
  Scenario Outline: activity-date @type="start-planned":@iso-date must be before @type="end-planned":@iso-date (IATI 1.x)
  ...
  Scenario Outline: activity-date @type="1":@iso-date must be before @type="3":@iso-date (IATI 2.x)
  ...
  Scenario Outline: activity-date @type="start-actual":@iso-date must be before @type="end-actual":@iso-date (IATI 1.x)
  ...
  Scenario Outline: activity-date @type="2":@iso-date must be before @type="4":@iso-date (IATI 2.x)
  ...
  Scenario Outline: budget period-start:@iso-date must be before period-end:@iso-date
  ...
  Scenario Outline: total-budget period-start:@iso-date must be before period-end:@iso-date
