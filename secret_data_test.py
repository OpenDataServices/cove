...
os.makedirs('secret_data_test/ocds', exist_ok=True)
...
for dirname in os.listdir('.'):
    print(dirname)
    with open(os.path.join(dirname, 'results.json')) as fp, open(os.path.join('..', '..', 'secret_data_test_archive', 'ocds', dirname, 'results.json')) as fp_archive:
